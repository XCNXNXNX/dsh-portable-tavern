...
var TavernApi = class {
  async generate(spec, version) {
    return post(TAVERN_API.generate, { spec, version, custom: customLlmPayload() });
  }
  async worldbook(spec, card) {
    return post(TAVERN_API.worldbook, { spec, card, custom: customLlmPayload() });
  }
  async models() {
  ...
  async test(custom) {
    return post(TAVERN_API.test, { custom });
  }
};
...
function loadTavernSettings() {
  try {
    ...
    return { width: 540, accent: "#4f7cff", showTrigger: true };
  }
}
...
function CardPreview(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stCardPreview, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stCardHead, children: [
      props.avatar ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { className: css.stCardAvatar, src: props.avatar, alt: d.name }) : null,
...
function PortableTavern(props) {
  ...
  const [ws] = (0, import_react.useState)(loadWorkspace);
  const [spec, setSpec] = (0, import_react.useState)(() => ws.spec ?? DEFAULT_SPEC);
  const [card, setCard] = (0, import_react.useState)(() => ws.card ?? null);
  const [version, setVersion] = (0, import_react.useState)(() => ws.version ?? "v2");
  ...
  const [worldbook, setWorldbook] = (0, import_react.useState)(() => ws.worldbook ?? null);
  ...
  const [chatMessages, setChatMessages] = (0, import_react.useState)(() => ws.chat ?? []);
  ...
  const [chatModel, setChatModel] = (0, import_react.useState)(() => ws.chatModel ?? "");
  const [globalPrompt, setGlobalPrompt] = (0, import_react.useState)(() => ws.globalPrompt ?? "");
  const [avatar, setAvatar] = (0, import_react.useState)(() => ws.avatar ?? "");
  const [savedChars, setSavedChars] = (0, import_react.useState)(loadCharacters);
  const [tavern, setTavern] = (0, import_react.useState)(loadTavernSettings);
  const [showTrigger, setShowTrigger] = (0, import_react.useState)(() => triggerStore.get());
  const [llmDraft, setLlmDraft] = (0, import_react.useState)(loadCustomLlm);
  const [llmTesting, setLlmTesting] = (0, import_react.useState)(false);
  const [llmTestResult, setLlmTestResult] = (0, import_react.useState)("");
  ...
  const secAvatar = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, { title: "\u89D2\u8272\u5934\u50CF", hint: "\u81EA\u5B9A\u4E49\u804A\u5929\u5934\u50CF\uFF0C\u53EF\u9009", defaultOpen: true, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stAvatarRow, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stAvatarPreview, style: avatar ? void 0 : { background: avatarGradient(spec) }, children: avatar ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { className: css.stAvatarPreviewImg, src: avatar, alt: "\u5934\u50CF\u9884\u89C8" }) : (spec.basic.name || "?").slice(0, 1) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stAvatarActions, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: css.stBtn, children: [
        "\u4E0A\u4F20\u56FE\u7247",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "file", accept: "image/*", style: { display: "none" }, onChange: onAvatarFile })
      ] }),
      avatar ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { onClick: onClearAvatar, children: "\u6E05\u9664" }) : null
    ] })
  ] }) });
  ...
  const renderPreview = () => {
    ...
    if (card) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardPreview, { card, avatar })
      ] });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
  ...
  const renderCharacter = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stChar, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stLib, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stLibHead, children: "\u89D2\u8272\u5E93\uFF08\u672C\u5730\u4FDD\u5B58\u89D2\u8272\u5361\u4E0E\u5BF9\u8BDD\u8BB0\u5F55\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stCustomAdd, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { variant: "primary", disabled: !card, onClick: onSaveCharacter, children: "\u4FDD\u5B58\u5F53\u524D\u89D2\u8272\u5230\u5E93" }) }),
        savedChars.length ? savedChars.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stLibItem, children: [
          c.avatar ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { className: css.stLibAvatar, src: c.avatar, alt: c.name }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: css.stLibAvatarFallback, children: (c.name || "?").slice(0, 1) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stLibName, children: c.name }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: css.stLibMeta, children: [
            c.chat.length,
            " \u6761 \xB7 ",
            new Date(c.savedAt).toLocaleDateString()
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { onClick: () => onLoadCharacter(c), children: "\u8F7D\u5165" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: css.stTplDel, title: "\u5220\u9664", onClick: () => onDeleteCharacter(c.id), children: "x" })
        ] }, c.id)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stLibMeta, children: "\u6682\u65E0\u4FDD\u5B58\u7684\u89D2\u8272" })
      ] }),
  ...
  const renderSettings = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stChar, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, { title: "\u5BF9\u8BDD\u7CFB\u7EDF\u63D0\u793A\u8BCD", hint: "\u6BCF\u6B21\u5BF9\u8BDD\u524D\u6CE8\u5165\uFF0C\u7C7B\u4F3C SillyTavern \u7684 System Prompt", defaultOpen: true, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u5168\u5C40\u6307\u4EE4\uFF08\u6CE8\u5165\u5230\u89D2\u8272\u8BBE\u5B9A\u4E4B\u524D\uFF0C\u652F\u6301 {{char}} / {{user}} \u5360\u4F4D\u7B26\uFF09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", { className: cx(css.stInput, css.stTextarea), rows: 5, value: globalPrompt, onChange: (e) => setGlobalPrompt(e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u4F60\u662F\u4E00\u4F4D\u4E13\u4E1A\u7684\u6545\u4E8B\u53D9\u8FF0\u8005\uFF0C\u59CB\u7EC8\u6C89\u6D78\u89D2\u8272\u3001\u4E0D\u8DF3\u51FA\u3001\u4E0D\u63D0\u53CA\u4EFB\u4F55\u8BBE\u5B9A\u4E0E\u89C4\u5219\uFF0C\u4F7F\u7528\u4E2D\u6587\u56DE\u590D\u2026\u2026" }) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, { title: "\u5916\u89C2", defaultOpen: true, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u60AC\u6D6E\u6309\u94AE", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: css.stCheck, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked: showTrigger, onChange: (e) => onToggleTrigger(e.target.checked) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, { title: "\u6A21\u578B\u63A5\u5165", hint: "\u9ED8\u8BA4\u76F4\u63A5\u4F7F\u7528 DSH \u5F53\u524D\u914D\u7F6E\u7684\u6A21\u578B\u4E0E\u5BC6\u94A5\uFF1B\u586B\u5199\u540E\u53EF\u6539\u8D70\u4F60\u81EA\u5DF1\u7684 OpenAI \u517C\u5BB9\u63A5\u53E3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u63A5\u53E3\u5730\u5740\uFF08Base URL\uFF0C\u81EA\u52A8\u62FC\u63A5 /chat/completions\uFF09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { className: css.stInput, value: llmDraft.baseUrl, onChange: (e) => setLlmDraft({ ...llmDraft, baseUrl: e.target.value }), placeholder: "https://api.deepseek.com" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "API Key\uFF08\u4EC5\u4FDD\u5B58\u5728\u672C\u6D4F\u89C8\u5668\uFF0C\u5BC6\u7801\u6846\u906E\u853D\u663E\u793A\uFF09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { className: css.stInput, type: "password", value: llmDraft.apiKey, onChange: (e) => setLlmDraft({ ...llmDraft, apiKey: e.target.value }), placeholder: "sk-\u2026", autoComplete: "off" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u6A21\u578B\u540D\u79F0", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { className: css.stInput, value: llmDraft.model, onChange: (e) => setLlmDraft({ ...llmDraft, model: e.target.value }), placeholder: "deepseek-chat" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u5F53\u524D\u72B6\u6001\uFF1A" + (customConfigured ? "\u5DF2\u542F\u7528\u81EA\u5B9A\u4E49\u63A5\u53E3\uFF08\u89D2\u8272\u5361 / \u4E16\u754C\u4E66 / \u804A\u5929\u53EF\u7528\uFF09" : "\u672A\u542F\u7528\uFF08\u4F7F\u7528 DSH \u9ED8\u8BA4\u6A21\u578B\uFF09"), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: cx(css.stRow, css.stGap), children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { variant: "primary", disabled: llmTesting, onClick: onTestLlm, children: llmTesting ? "\u6D4B\u8BD5\u4E2D\u2026" : "\u4FDD\u5B58\u5E76\u6D4B\u8BD5\u8FDE\u63A5" }),
        customConfigured ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { onClick: onClearLlm, children: "\u6E05\u9664\u914D\u7F6E" }) : null
      ] }) }),
      llmTestResult ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stNotice, children: llmTestResult }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stLabel, children: "API Key \u53EA\u5B58\u5728\u672C\u673A\u6D4F\u89C8\u5668 localStorage\uFF0C\u4EC5\u53D1\u9001\u7ED9\u672C\u673A\u9152\u9986\u8DEF\u7531\u8F6C\u53D1\u8BF7\u6C42\uFF0C\u4E0D\u5199\u5165\u4EFB\u4F55\u65E5\u5FD7\uFF1B\u804A\u5929\u9875\u7684\u6A21\u578B\u4E0B\u62C9\u4E2D\u9009\u62E9\u300C\u81EA\u5B9A\u4E49\u300D\u5373\u53EF\u5207\u6362\u5230\u8BE5\u63A5\u53E3\u3002" })
    ] }),
  ...
  const renderChat = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stChat, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stChatHead, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stChatAvatar, style: avatar ? void 0 : { background: avatarGradient(spec) }, children: avatar ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { className: css.stChatAvatarImg, src: avatar, alt: d.name }) : (d.name || "?").slice(0, 1) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stChatMeta, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { className: cx(css.stInput, css.stChatModel), value: chatModel, onChange: (e) => setChatModel(e.target.value), children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "custom::", children: customConfigured ? "\u81EA\u5B9A\u4E49 \xB7 " + llmDraft.model : "\u81EA\u5B9A\u4E49\u6A21\u578B\uFF08\u672A\u914D\u7F6E\uFF09" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { id: "pt-chat-log", className: css.stChatLog, children: chatMessages.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: cx(css.stMsg, m.role === "assistant" ? css.stMsgChar : css.stMsgUser), children: [
        m.role === "assistant" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stMsgAvatar, style: avatar ? void 0 : { background: avatarGradient(spec) }, children: avatar ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { className: css.stMsgAvatarImg, src: avatar, alt: d.name }) : (d.name || "?").slice(0, 1) }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: css.stMsgBubble, children: m.content })
      ] }, i)) }),
...
function TavernRoot(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stRoot, children: [
    showTrigger ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: open ? "none" : "block" }, children: trigger }) : null,
...
function SettingsEntry(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: css.stSettingsEntry, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: cx(css.stRow, css.stGap), children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: css.stCheck, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked: showTrigger, onChange: (e) => setTriggerVisible(e.target.checked) }),
        "\u60AC\u6D6E\u6309\u94AE"
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: css.stSectionHint, children: "\u5173\u95ED\u60AC\u6D6E\u6309\u94AE\u540E\uFF0C\u4ECD\u53EF\u4ECE\u6B64\u9875\u6253\u5F00\u9152\u9986" })
  ] });
}
